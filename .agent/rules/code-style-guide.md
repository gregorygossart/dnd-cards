...
7. When importing types, always use inline "type" like `import { type MyType } from "package"` and never like `import type { MyType } from "package"`
8. Develop important features as vertical slices in src/features/{featureName}
9. Work with features as vertical slices: "features/spells", "features/items/weapons", "features/items/armors", etc...
10. Never add `import React from "react";` at the top of the .tsx files
