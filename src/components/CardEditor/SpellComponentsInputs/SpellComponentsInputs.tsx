        ...
        <div>
            ...
            <div className="flex gap-4">
                <div className="flex-1 flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="verbal" className="text-slate-300 font-normal cursor-pointer">
                        Verbal
                    </Label>
                </div>
                ...
                <div className="flex-1 flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="somatic" className="text-slate-300 font-normal cursor-pointer">
                        Somatic
                    </Label>
                </div>
                ...
                <div className="flex-1 flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="material" className="text-slate-300 font-normal cursor-pointer">
                        Material
                    </Label>
                </div>
            </div>
