        ...
        <div className="col-span-2">
            <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="ritual" className="text-xs font-normal text-slate-400 cursor-pointer">
                        Ritual
                    </Label>
                </div>
            </div>
                        ...
                        render={({ field }) => (
                            <Select onValueChange={field.onChange} value={field.value}>
                                ...
                                <SelectContent className="bg-slate-800 border-slate-700 text-slate-100">
                                    ...
                                    <SelectItem value={CastingTimeUnit.BonusAction}>Bonus Action</SelectItem>
                                    <SelectItem value={CastingTimeUnit.Reaction}>Reaction</SelectItem>
                                    <SelectItem value={CastingTimeUnit.Minute}>Minute(s)</SelectItem>
