        ...
        <>
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Select onValueChange={field.onChange} value={field.value}>
                            <SelectTrigger id="school" className="bg-slate-800 border-slate-700 text-slate-100 w-full h-9">
            ...
            <div>
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Select
                            onValueChange={(val) => field.onChange(val === '' ? undefined : parseInt(val))}
                            value={field.value?.toString() ?? ''}
                        >
                            <SelectTrigger id="level" className="bg-slate-800 border-slate-700 text-slate-100 w-full h-9">
