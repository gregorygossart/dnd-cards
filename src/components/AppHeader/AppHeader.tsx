...
export const AppHeader: React.FC = () => {
    const { leftDrawerOpen, setLeftDrawerOpen, rightDrawerOpen, setRightDrawerOpen } = useUIStore();
        ...
        <header className="h-14 border-b border-slate-800 bg-slate-900/50 flex items-center justify-between px-4 lg:px-6">
            ...
            <div className="flex items-center gap-3 min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2 text-sm min-w-0">
                    ...
                    <h1 className="font-semibold text-slate-200 truncate">{currentCard.title || 'Untitled Card'}</h1>
                </div>
            </div>
